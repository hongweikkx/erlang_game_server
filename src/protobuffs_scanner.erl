...
-file("src/protobuffs/protobuffs_scanner.xrl", 24).
...
-file("src/protobuffs_scanner.erl", 291).
yystate() -> 23.
...
-file("src/protobuffs/protobuffs_scanner.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { var, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/3}).
-file("src/protobuffs/protobuffs_scanner.xrl", 10).
yyaction_1(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { string, TokenLine, S } } .

-compile({inline,yyaction_2/3}).
-file("src/protobuffs/protobuffs_scanner.xrl", 12).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { string, TokenLine, S } } .

-compile({inline,yyaction_3/2}).
-file("src/protobuffs/protobuffs_scanner.xrl", 14).
yyaction_3(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_4/0}).
-file("src/protobuffs/protobuffs_scanner.xrl", 15).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/0}).
-file("src/protobuffs/protobuffs_scanner.xrl", 16).
yyaction_5() ->
     skip_token .

-compile({inline,yyaction_6/0}).
-file("src/protobuffs/protobuffs_scanner.xrl", 17).
yyaction_6() ->
     skip_token .

-compile({inline,yyaction_7/2}).
-file("src/protobuffs/protobuffs_scanner.xrl", 18).
yyaction_7(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_8/2}).
-file("src/protobuffs/protobuffs_scanner.xrl", 19).
yyaction_8(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_9/2}).
-file("src/protobuffs/protobuffs_scanner.xrl", 20).
yyaction_9(TokenChars, TokenLine) ->
